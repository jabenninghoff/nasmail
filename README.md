...
Users are defined in `/opt/nasmail/users/nasmail-users`, using the [passwd](https://doc.dovecot.org/2.4.5/core/config/auth/databases/passwd_file.html) file format, using the following format:
